...
const openMenu = (data = null) => {
    ...
    $('#container').removeClass('hidden');  // Show the container and server name
    $('#server-name').removeClass('hidden'); // Ensure the server name is visible
...
const closeMenu = () => {
    ...
    $('#container').addClass('hidden');  // Hide the container and server name
    $('#server-name').addClass('hidden'); // Ensure the server name is hidden
    buttonParams = [];
};
